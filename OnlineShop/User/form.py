...
class CustomerCreationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields=[
             'email','password1','password2','phone_number','zip_code','national_id'
        ]
        ...
        error_messages = {
            ...
            'zip_code': {
                'unique': 'این کدپستی از قیل وارد شده است',
                'required':'پرکردن فیلدالزامی است'
            },
            'national_id': {
...
class SupplierCreationForm(CustomerCreationForm):
    ...
    class Meta(CustomerCreationForm.Meta):
        ...
        fields=[
              'email','password1','password2','phone_number','zip_code','national_id','shop_name',
        ]
